...
This project automates the process of collecting documents from users via email, tracking submissions, updating records in an Excel workbook, and providing a web-based interface to monitor the status.

It combines **Excel macros, email automation, file storage, database tracking, and a Flask-based web interface** into a single integrated workflow.
...
## 3. Email System
Handles communication and document collection.
...
- Submit required documents by replying with attachments  

---

## 5. Attachments
User-submitted documents are:

- Stored in an organized directory structure  
- Logged with metadata such as:
  - Sender email  
  - File name  
  - Timestamp  
...
## 6. Database
Stores metadata related to file submissions:

- Submitter identity  
- Document details  
- Submission time  

Supports the **web dashboard and document tracking system**.
...
- Database updates  
- Excel manipulation (`openpyxl` / `xlwings`)  
...
- Submission tracking and status indicators (pending/complete)  
- File search and download *(optional)*  
- Local or cloud hosting  

![System Preview](https://github.com/user-attachments/assets/d288f785-c4a1-4a15-85fb-2c5bcde76167)
...
![Workflow Diagram](https://github.com/user-attachments/assets/fbf58db7-0665-4cf8-8f66-88037f2ca04b)
